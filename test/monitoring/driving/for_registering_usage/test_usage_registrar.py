...
from src.monitoring.usage.usage_information import (
    UsageInformationPrimitives,
    UsageInformation,
)
from test.monitoring.driving.for_registering_usage.register_usage_command_mother import (
    RegisterUsageCommandMother,
)
...
class TestUsageRegistrar:
    ...
    def test_should_register_command_usage(self) -> None:
        ...
        usage_information_primitives = UsageInformationPrimitivesMother.from_command(
            command
        )
    ...
    def _should_have_send_usage_information(
        self, expected_information: UsageInformationPrimitives
    ) -> None:
        assert_that(
